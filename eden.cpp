...
///
/// \brief Eden::ToUpper - Converts string to upper case
/// \param X
/// \return
///
string Eden::ToUpper(string X)
{
    string XX = "";
    int S = X.size();
    for (int I = 0; I < S; I++)
...
///
/// \brief Eden::ToLower - Converts string to lower case
/// \param X
/// \return
///
string Eden::ToLower(string X)
{
    string XX = "";
    int S = X.size();
    for (int I = 0; I < S; I++)
